...
class UnusedConnectionSymbol(LogicSymbol):
    """
    Visual marker for a source port whose wire drives no sink.
    Drawn as a small open stub with an 'NC' (no connect) label so it's
    obvious at a glance during debugging.
    """
    _WIDTH  = 30
    _HEIGHT = 22
